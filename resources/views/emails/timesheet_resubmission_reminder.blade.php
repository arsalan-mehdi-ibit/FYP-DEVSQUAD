...
<head>
    <meta charset="UTF-8">
    <title>Timesheet Re-Submission Reminder</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>You still haven’t resubmitted your rejected timesheet for the week ending on
            ...
            <p>Please resubmit it as soon as possible</p>
        </div>
