                            ...
                            <div class="col-md-6 mb-3 position-relative">
                                ...
                                <div class="position-relative">
                                    <input type="password" class="password-field pr-5" id="password" name="password"
                                        ...
                                        style="background-color: #eef0f7; color: black; border-radius: 0px; padding: 7px; width: 100%;">

                                    <!-- Eye Icon -->
                                    <span class="toggle-password" inset-y-2 right-6 flex items-center cursor-pointer
                            ...
                            <div class="col-md-6 mb-3 position-relative">
                                ...
                                <div class="position-relative">
                                    <input type="password" class="password-field pr-5" id="password_confirmation"
                                        ...
                                        placeholder="Confirm new password"style="background-color: #eef0f7; color: black; border-radius: 0px; padding: 7px; width: 100%;">
