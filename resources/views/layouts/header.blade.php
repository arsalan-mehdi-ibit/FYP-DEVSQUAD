            ...
            <div class="flex items-center gap-2 sm:gap-3 md:gap-4">
                ...
                <div class="relative z-50">
                    ...
                    <div class="relative cursor-pointer" id="notificationBell">
                        ...
                        <span id="notificationCount" class="absolute -top-1 -right-2 bg-red-500 text-white text-xs px-1.5 rounded-full">0</span>

                    </div>
            
                    <!-- Notification Dropdown -->
                    <div id="notificationDropdown" class="absolute mt-2 w-96 bg-white text-sm rounded-2xl shadow-2xl hidden">
                        <!-- Top Tab -->
                        ...
                        {{-- <div class="p-2 text-center border-t">
                            <a href="#" class="text-blue-600 font-semibold hover:underline">See all incoming activity</a>
                        </div> --}}
                    </div>
                </div>
