...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-12 col-md-11 col-lg-10 col-xl-9 ms-auto px-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center pt-4 mb-3 border-bottom">
    ...
    <h2 class="accordion-header" id="headingOne">
        <button class="accordion-button text-black text-md font-semibold py-2 px-2 w-full flex justify-between items-center"
            ...
            <div class="bg-white rounded-lg shadow-sm p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" readonly class="form-control" value="{{ $project->client->firstname  }}  {{$project->client->lastname}}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Consultant</label>
                        <input type="text" readonly class="form-control" value="{{ $project->consultant }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Client Rate</label>
                        <input type="text" readonly class="form-control" value="{{ $project->client_rate }}">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" readonly class="form-control" value="{{ $project->referral_source }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Notes</label>
                        <textarea readonly class="form-control" rows="2">{{ $project->notes }}</textarea>
                    </div>
                </div>
            </div>
        </div>
...
<div class="accordion-item border-none rounded-lg mb-3">
    <h2 class="accordion-header" id="headingTwo">
        <button class="accordion-button text-black collapsed text-sm font-semibold py-2 px-3 w-full flex justify-between items-center"
