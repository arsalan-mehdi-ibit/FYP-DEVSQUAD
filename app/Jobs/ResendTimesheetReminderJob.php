...
class ResendTimesheetReminderJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if ($contractor && $contractor->email) {
            ...
            Mail::to($contractor->email)->send(new EmailSender(
                subject: 'Reminder: Resubmit Your Rejected Timesheet',
                data: $emailData,
                bladeTemplate: 'emails.timesheet_resubmission_reminder'
            ));
        }
    }
